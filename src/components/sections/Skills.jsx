        ...
        <div className="bg-gray-900 rounded-lg p-6 shadow-2xl border border-gray-700">
          ...
          <pre className="text-green-400 font-mono text-sm leading-relaxed overflow-x-auto">
            <code>
              ...
              <span className="text-gray-300">  </span><span className="text-red-300">backend</span><span className="text-white">:</span> <span className="text-gray-300">[</span><span className="text-green-300">{'Node.js'}</span><span className="text-gray-300">,</span> <span className="text-green-300">{'Express'}</span><span className="text-gray-300">],</span>{"\n"}
              <span className="text-gray-300">  </span><span className="text-red-300">devops</span><span className="text-white">:</span> <span className="text-gray-300">[</span><span className="text-green-300">{'Docker'}</span><span className="text-gray-300">,</span> <span className="text-green-300">{'Git'}</span><span className="text-gray-300">,</span> <span className="text-green-300">{'GitHub Actions'}</span><span className="text-gray-300">,</span> <span className="text-green-300">{'Linux'}</span><span className="text-gray-300">],</span>{"\n"}
              ...
              <span className="text-gray-300">  </span><span className="text-red-300">cloud</span><span className="text-white">:</span> <span className="text-gray-300">[</span><span className="text-green-300">{'Vercel'}</span><span className="text-gray-300">,</span> <span className="text-green-300">{'Heroku'}</span><span className="text-gray-300">]</span>{"\n"}
              <span className="text-gray-300">  </span><span className="text-red-300">testing</span><span className="text-white">:</span> <span className="text-gray-300">[</span><span className="text-green-300">{'JUnit'}</span><span className="text-gray-300">,</span> <span className="text-green-300">{'Jest'}</span><span className="text-gray-300">]</span>{"\n"}
